  ...
  return (
    <div className='PageOrders'>
      <div className='PageOrders__title'>
        Мої замовлення
        <div className='hiddenHint'>Ваші останні замовлення:</div>
      </div>
          ...
          <div key={order.id} className='order-card'>
            ...
            <div className='detailed-order-summary'>
              <div className='detailed-order-summary__grid'>
                <div className='name__line'>Статус</div>
                <div
                  className='order-status'
                  data-status={order.status.toLowerCase()}
                >
                ...
                <div className='name__line'>Спосіб оплати:</div>
                <div className='order-payment'>
                  <div className='payment-icon'>
                    <PaymentSvg />
                  </div>
                ...
                <div className='name__line'>Спосіб доставки:</div>
                <div className='order-delivery'>
                  <div className='delivery-icon'>
                    <DeliverySvg />
                  </div>
              ...
              <div className='order-divider'></div>
              <div className='order-amount'>
                Загалом: {order.totalAmount.toFixed(2)} ₴
              </div>
              <div className='order-divider'></div>
              <button
                className='details-button'
