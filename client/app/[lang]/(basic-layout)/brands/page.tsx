...
const page = async ({ params: { lang } }: { params: { lang: Locale } }) => {
  ...
  return (
    <div className='list-brends-container'>
      <BreadCrumbs
        listUrles={[{ url: `brands`, name: listBrends.title }]}
        lang={lang}
      />
      <h1>{listBrends.title}</h1>
      <div className='list-letter-Brend-container'>
        <div className='list-letter-Brend'>
      ...
      <div className='list-brends'>
        {brends.map((x: any, index: number) => (
          <div key={x.id} className='brends-and-title-letter'>
            <p>{x.startWith}</p>
